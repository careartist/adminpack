    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <!-- ==== Items ==== -->
          <li class="treeview">
            <a href="#"><i class="fa fa-newspaper-o"></i> <span>Art works</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              <li><a href="{{ url('admin/item') }}"><i class="fa fa-newspaper-o"></i> <span>Items</span></a></li>
              <li><a href="{{ url('admin/type') }}"><i class="fa fa-tag"></i> <span>Types</span></a></li>
